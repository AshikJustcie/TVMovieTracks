...
public class EditMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String DId,DTitle, DLink,DStatus,DCollection,DType,DStarts,DEnds,DGender;
    int DRating;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DTitle = intent.getStringExtra("DataTITLE");
        DLink = intent.getStringExtra("DataLINK");
        DStatus = intent.getStringExtra("DataSTATUS");
        DRating = intent.getIntExtra("DataRATING",0);
        DCollection = intent.getStringExtra("DataCOLLECTION");
        DType = intent.getStringExtra("DataTYPE");

        DStarts = intent.getStringExtra("DataSTARTS");
        DEnds = intent.getStringExtra("DataENDS");

        DGender = intent.getStringExtra("DataGENDER");

        Title.setText(DTitle);
        Status.setText(DStatus);
        Collection.setText(DCollection);
        Type.setText(DType);

        if (DRating != 0) {
            seekBarLayout.setVisibility(View.VISIBLE);
            ratingBar.setProgress(DRating);
        }
        else {
            seekBarLayout.setVisibility(View.GONE);
        }

        TVStarts.setText(DStarts);
        TVEnds.setText(DEnds);
        ...
        else if (DType.equals("TV Animated")) {
            Type.setText(R.string.TV_Animated);
        ...
        else if (DType.equals("Celebrity")) {
            Type.setText(R.string.Celebrity);
        ...
        else if (DType.equals("Singer")) {
            Type.setText(R.string.Singer);
    ...
    private void GetStartDate() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(EditMainActivity.this,
    ...
    private void UpdateArtists() {
        ...
        if (!TextUtils.isEmpty(title) && !TextUtils.isEmpty(link)) {
            ...
            if (type.equals("Celebrity")) {
                ...
                Toast.makeText(getApplicationContext(), "Successfully Updated celebrity:)",Toast.LENGTH_SHORT).show();
                finish();
            }
                ...
                Toast.makeText(getApplicationContext(), "Successfully Updated Singer:)",Toast.LENGTH_SHORT).show();
                fileList();
            }
